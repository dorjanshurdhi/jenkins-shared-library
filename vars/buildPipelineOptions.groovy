...
def call(Map configMap) {
    ...
    pipeline {
        ...
        stages {
            ...
            if (configMap.runSonarQubeAnalysis) {
            ...
            if (configMap.runBuildContainer) {
            ...
            if (configMap.runTechdocsGeneration) {
            ...
            if (configMap.runTechdocsPublish) {
